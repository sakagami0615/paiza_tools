...
class QuestionContent:
    ...
    def __init__(self, html: str, ques_number: str, ques_sentence: str,
                 var_format: Optional[str], excepted_output: Optional[str], condition: Optional[str],
                 n_test_cases: int, input_list: List[str], answer_list: List[str]):
    ...
    def __eq__(self, other):
        ...
        return (self.html == other.html and
                self.ques_number == other.ques_number and
                self.ques_sentence == other.ques_sentence and
                self.var_format == other.var_format and
                self.excepted_output == other.excepted_output and
                self.condition == other.condition and
                self.n_test_cases == other.n_test_cases and
                self.input_list == other.input_list and
    ...
    def __str__(self):
        ...
        for i, (input_item, answer_item) in enumerate(zip(self.input_list, self.answer_list)):
