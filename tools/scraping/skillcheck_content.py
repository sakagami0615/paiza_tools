...
class SkillcheckContent:
    ...
    def _find_text_in_box_class(self, src_soup: BeautifulSoup, class_text: str) -> Optional[BeautifulSoup]:
    ...
    def _extract_excepted_output(self, page_soup: BeautifulSoup) -> Optional[str]:
        ...
        excepted_soup = self._find_text_in_box_class(inr2_soup, self.EXPECTED_OUTPUT_CLASS_TEXT)
    ...
    def _extract_condition(self, page_soup: BeautifulSoup) -> Optional[str]:
        ...
        condition_soup = self._find_text_in_box_class(inr2_soup, self.CONDITION_CLASS_TEXT)
    ...
    def _extract_testcase_data(self, page_soup: BeautifulSoup) -> Tuple[int, List[str], List[str]]:
    ...
    def create_question_content(self) -> QuestionContent:
        ...
        return QuestionContent(page_html, ques_number, ques_sentence,
                               var_format, excepted_output, condition,
                               n_test_cases, input_list, answer_list)
